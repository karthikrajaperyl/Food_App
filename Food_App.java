...
public class Food_App {
	...
	protected void addRestaurentDetails() throws IOException, Exception {
		...
		Performance tempObj = getRestaurantPerformance();
		restaurantObj.setRestaurantPerformance(tempObj);
	...
	public int getCouponId(Order userObj) throws IOException {
		BufferedReader readerObj = new BufferedReader(new InputStreamReader(System.in));
		String restaurantsName = userObj.getRestaurantName();
		System.out.println("Enter the CouponId");
		showCoupon(restaurantsName);
		return Integer.parseInt(readerObj.readLine());
	}
